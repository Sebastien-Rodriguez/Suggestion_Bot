...
from ..tools import Logging, CheckConfig, GetObjectConfig
...
class BotSetup(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot) -> None:
        self.bot = bot
        self.guild = GetObjectConfig(bot).get_guild()
    ...
    async def setup_bot_suggestion(self, interaction: discord.Interaction) -> None:
        ...
        # Un décorateur a la place ? tu ma mis aussi dans le check de config
